...
HRESULT Nero_RWing::Awake()
{
	...
	pNode = m_pMesh->GetNode("R_WingCloth01_end");
	...
	pClothBone = new CLOTHBONE;
	pNode = m_pMesh->GetNode("R_WingCloth00_00");
	pClothBone->sName = pNode->Name;
	pClothBone->pParent = nullptr;
	pClothBone->matToRoot = pNode->ToRoot;
	pClothBone->pNode = pNode;
	...
	pClothBone = new CLOTHBONE;
	pNode = m_pMesh->GetNode("R_WingCloth00_01");
	pClothBone->sName = pNode->Name;
	...
	pClothBone = new CLOTHBONE;
	pNode = m_pMesh->GetNode("R_WingCloth00_02");
	pClothBone->sName = pNode->Name;
	pClothBone->pParent = m_vecClothBone.back();
	pClothBone->matToRoot = pNode->ToRoot;
	pClothBone->pNode = pNode;
	...
	pClothBone = new CLOTHBONE;
	pNode = m_pMesh->GetNode("R_WingCloth00_03");
	pClothBone->sName = pNode->Name;
	pClothBone->pParent = m_vecClothBone.back();
	pClothBone->matToRoot = pNode->ToRoot;
	pClothBone->pNode = pNode;
	...
	pClothBone = new CLOTHBONE;
	pNode = m_pMesh->GetNode("R_WingCloth00_end");
	pClothBone->sName = pNode->Name;
	pClothBone->pParent = m_vecClothBone.back();
	pClothBone->matToRoot = pNode->ToRoot;
	pClothBone->pNode = pNode;
	...
	for (UINT i = 0; i < m_vecClothBone.size(); ++i)
	{
		...
		float fInvMass = m_vecClothBone[i]->pParent == nullptr ? 0.f : i * 0.25f;
