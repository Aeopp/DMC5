...
PsOut PsMain0(PsIn In)
{
    ...
    float4 c2 = float4(ATOSSample.r * _BrightScale * exposure_corr * float3(0.996f, 0.011f, 0.009f), 1.f);
    c2.a = saturate(ATOSSample.r);
   
    float4 c3 = float4(ATOSSample.b * _BrightScale * exposure_corr * float3(0.923f, 0.039f, 0.015f), 1.f);
