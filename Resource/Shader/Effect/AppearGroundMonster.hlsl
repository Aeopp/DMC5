...
PsOut PsMain0(PsIn In)
{
    ...
    Out.Color = float4(0.05f * _BrightScale * exposure_corr, 0.f, 0.f, saturate((MskSample.b - 0.5f) * 2.f));
...
PsOut PsMain1(PsIn In)
{
    ...
    Out.Color = float4(0.1f * _BrightScale * exposure_corr, 0.f, 0.f, saturate((MskSample.g - 0.5f) * 2.f));
